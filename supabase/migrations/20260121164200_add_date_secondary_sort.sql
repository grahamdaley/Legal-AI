-- Add secondary sort by date (most recent first) while keeping relevance as primary sort
...
BEGIN
    ...
    ORDER BY ce.embedding <=> query_embedding, cc.decision_date DESC NULLS LAST
    LIMIT match_count;
END;
$$;
